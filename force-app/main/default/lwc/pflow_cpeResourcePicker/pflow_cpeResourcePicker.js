...
} from 'c/pflow_cpeResourcePickerUtils';
...
export default class PflowCpeResourcePicker extends LightningElement {
 @api name;
 @api label;
 @api required = false;
 ...
 if (this._value && this._value.endsWith(event.currentTarget.dataset.value) && event.currentTarget.dataset.objectType) {
 ...
 this.applyInternalValue(this.getFullPath(this._selectedFieldPath, event.currentTarget.dataset.value));
